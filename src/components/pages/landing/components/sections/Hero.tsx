...
export function Hero(): ReactElement {
  ...
  return (
    <>
      ...
      <div
        className={
          'hidden w-full justify-center overflow-hidden border-b border-white/10 md:flex'
        }
      >
        <div
          style={{
      ...
      <div
        className={
          'flex w-full flex-col items-center bg-white/5 px-4 py-12 pt-20 sm:py-16 sm:pt-24 md:hidden'
        }
        style={{
